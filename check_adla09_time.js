...
async function run() {
  ...
  if (res.rows.length === 0) {
    console.log("No reports found for ADLA09 on 2026-07-11");
  } else {
    for (const r of res.rows) {
      ...
      console.log("Report ID: " + r.id + " | Draft Saved At (IST): " + istTime + " | Final Submit Timestamp in Meta: " + finalSubmitTime + " | isFinal: " + isFinal);
    }
  }
